...
#include <time.h>//BIBLIOTECA PARA USAR FUNÇÃO ALEATORIA
#include <ctype.h>
...
void addPalavra(){
	...
	while(!feof(temp)){//Checar se a dicas é existente no arquivo
...
void addDica(){
	...
	while(!feof(arquivo)){//loop verificar se dica é existente
